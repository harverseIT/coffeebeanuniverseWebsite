import { r as u, o as l, c as n, a as t, b as p, w as Z, n as g, F as _, d as b, t as h, u as M, p as x, e as B, f, g as C, h as y, i as W, j as X, k as Y, l as K, m as z, q as tt, s as et } from "./vendor.5ba80965.js";
const at = function() { const s = document.createElement("link").relList; if (s && s.supports && s.supports("modulepreload")) return; for (const a of document.querySelectorAll('link[rel="modulepreload"]')) d(a);
    new MutationObserver(a => { for (const c of a)
            if (c.type === "childList")
                for (const i of c.addedNodes) i.tagName === "LINK" && i.rel === "modulepreload" && d(i) }).observe(document, { childList: !0, subtree: !0 });
    ...
    function d(a) { if (a.ep) return;
        a.ep = !0; const c = o(a);
        fetch(a.href, c) } };
at();
var ot = "/assets/logo-primary-nav.330e905e.png";
const F = [{ path: "/#about", label: "About" }, { path: "/#features", label: "Features" }, { path: "/blog", label: "Blog" }, { path: "/#gallery", label: "Gallery" }, { path: "/#products", label: "Product" }, { path: "/#contact-us", label: "Contact Us" }];
var m = (e, s) => { const o = e.__vccOpts || e; for (const [d, a] of s) o[d] = a; return o };
const st = { name: "NavTop", data() { return { navLogoWhite: ot, maxHeight: 64, isScrolled: !1, menus: F, isMobileOpen: !1 } }, mounted() { let e = this;
            window.addEventListener("scroll", s => { e.isScrolled = window.scrollY > e.maxHeight }) }, methods: { closeMenu() { this.isMobileOpen = !this.isMobileOpen }, selected(e) { return this.$route.fullPath === e ? "nav-selected" : "" }, scrollTo(e) { if (this.isMobileOpen && (this.isMobileOpen = !1), e.includes("#")) { let s = document.getElementById(e.substr(2)); if (s) { let d = s.getBoundingClientRect().top,
                            a = window.scrollY;
                        console.log(a), window.scrollTo(0, d + a - 120), this.$router.push(e) } else this.$router.push(e).then(o => { this.scrollTo(e) }) } else this.$router.push(e) } } },
    lt = { class: "navb" },
    nt = ["src"],
    it = ["onClick"],
...
`, image: _t }, { label: "marketing.ijennusantara@gmail.com", source: "mailto:marketing.ijennusantara@gmail.com", image: gt }, { label: "+6285156077857", source: "https://wa.me/6285156077857", image: mt }],
    bt = [{ label: "About", path: "/#about" }, { label: "Features", path: "/#features" }, { label: "Product", path: "/#products" }, { label: "Gallery", path: "/#gallery" }, { label: "Blog", path: "/blog" }];
var E = { footerNavContact: ft, footerNavHome: bt };
...
function se(e, s, o, d, a, c) { return l(), n("div", oe, [o.withoutDivider ? y("", !0) : (l(), n("span", { key: 0, class: g(o.isPrimary ? "is-primary" : "") }, null, 2)), t("p", { class: g("whitespace-pre-wrap md:whitespace-nowrap " + o.isBig ? "is-big" : o.isSmall ? "is-small" : "") }, h(o.title), 3)]) }
var L = m(ae, [
        ["render", se],
        ["__scopeId", "data-v-18e7f9c7"]
    ]),
    le = "/assets/Arabica Java.717a192f.png",
...
function Ce(e, s, o, d, a, c) { const i = u("SectionTitle"); return l(), n("div", de, [t("div", pe, [p(i, { title: "Our Product" }), (l(!0), n(_, null, b(a.products, r => (l(), n("div", he, [t("div", ue, [t("p", ve, h(r.name), 1), t("div", _e, [t("p", ge, h(r.name), 1), (l(), W(X("p"), { innerHTML: r.description }, null, 8, ["innerHTML"])), t("a", { target: "_blank", rel: "noreferrer noopener", href: r.source, class: "btn-sm" }, "Order Now", 8, me)]), t("a", { target: "_blank", rel: "noreferrer noopener", href: r.source, class: "btn" }, "Order Now", 8, fe)]), t("img", { src: r.image, class: "product-image" }, null, 8, be)]))), 256))])]) }
var Ae = m(re, [
        ["render", Ce],
...
const I = function(e) { const s = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]; let o = new Date(e); return `${o.getDate()} ${s[o.getMonth()]} ${o.getFullYear()}` },
    ...
    Oe = function(e) { return new Promise((s, o) => { Y.get(P + e).then(d => { s(d.data) }).catch(d => { o(d) }) }) },
    qe = function(e, s) { return Y.post(P + e) };
var A = { BASE_URL: P, routes: Je, get: Oe, post: qe };
const We = { components: { SectionTitle: L }, data() { return { blogs: [], blogMain: k } }, methods: { dateformat(e) { return I(e) }, retrieveBlog() { let e = this;
                A.get(A.routes.latestPosts + 3).then(s => { e.blogs = s }) } }, mounted() { this.retrieveBlog() } },
...
function ca(e, s, o, d, a, c) { const i = u("SectionTitle"),
        r = u("router-link"); return l(), n("div", Xe, [Ke, t("div", ze, [p(i, { title: "Blog", class: "pt-6 px-6" }), t("div", ta, [(l(!0), n(_, null, b(a.blogs, v => (l(), n("div", ea, [t("img", { src: v.image_url || a.blogMain, class: "blog-card-image" }, null, 8, aa), t("div", oa, [t("p", sa, h(v.title), 1), t("p", la, h(v.content.length > 120 ? v.content.substring(0, 120) + "..." : v.content), 1), p(r, { to: "/blog/" + v.slug, class: "btn absolute bottom-6" }, { default: Z(() => [na]), _: 2 }, 1032, ["to"]), t("p", ia, h(c.dateformat(v.published_at)), 1)])]))), 256))])])]) }
var ra = m(We, [
    ["render", ca],
...
const Ya = { name: "Home", components: { HomeGallery: Na, HomeContact: Ha, HomeWeAreHere: va, HomeBlog: ra, HomeWhyChooseUs: De, HomeAbout: Ue, HomeProducts: Ae, HomeBrand: ee }, beforeRouteUpdate(e, s, o) { let d = e.fullPath; if (d.includes("#")) { let a = document.getElementById(d.substr(2)); if (a) { let i = a.getBoundingClientRect().top,
                    r = window.scrollY;
                console.log(r), window.scrollTo(0, i + r - 120), o() } else o(), this.scrollTo(d) } } };

function Fa(e, s, o, d, a, c) { const i = u("HomeBrand"),
        r = u("HomeAbout"),
        v = u("HomeWhyChooseUs"),
        w = u("HomeProducts"),
        D = u("HomeGallery"),
        J = u("HomeBlog"),
        O = u("HomeWeAreHere"),
        q = u("HomeContact"); return l(), n(_, null, [p(i), p(r), p(v), p(w), p(D), p(J), p(O), p(q)], 64) }
var Ea = m(Ya, [
    ["render", Fa]
]);
...
function t1(e, s, o, d, a, c) { return l(), n("div", Va, [Ga, t("div", ja, [t("a", { onClick: s[0] || (s[0] = i => c.gotoPage(1)), class: g(a.current === 1 ? "disabled" : "") }, "First", 2), (l(), n("svg", { class: g("arrow-paginate " + (a.current === 1 ? "active" : "")), onClick: s[1] || (s[1] = i => c.gotoPage(a.current - 1)), width: "24", height: "25", viewBox: "0 0 24 25", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, Ja, 2)), a.current > 3 && o.total > 4 || a.current === 3 && o.total === 5 ? (l(), n("a", Oa, "...")) : y("", !0), (a.current < 4 || o.total === 4) && (a.current !== 3 || o.total !== 5) ? (l(!0), n(_, { key: 1 }, b(o.total >= 4 ? 4 : o.total, i => (l(), n("a", { onClick: r => c.gotoPage(i), class: g(a.current === i ? "active" : "") }, h(i), 11, qa))), 256)) : y("", !0), a.current > 3 && o.total - a.current > 2 ? (l(), n("a", { key: 2, onClick: s[2] || (s[2] = i => c.gotoPage(a.current - 1)) }, h(a.current - 1), 1)) : y("", !0), a.current > 3 && o.total - a.current > 2 ? (l(), n("a", { key: 3, onClick: s[3] || (s[3] = i => c.gotoPage(a.current)), class: "active" }, h(a.current), 1)) : y("", !0), a.current > 3 && o.total - a.current > 2 ? (l(), n("a", { key: 4, onClick: s[4] || (s[4] = i => c.gotoPage(a.current + 1)) }, h(a.current + 1), 1)) : y("", !0), o.total - a.current > 2 && o.total > 4 ? (l(), n("a", Wa, "...")) : y("", !0), o.total - a.current < 3 && o.total > 4 ? (l(!0), n(_, { key: 6 }, b(o.total >= 5 ? 4 : 0, i => (l(), n("a", { onClick: r => c.gotoPage(o.total + i - 4), class: g(a.current === o.total + i - 4 ? "active" : "") }, h(o.total + i - 4), 11, Xa))), 256)) : y("", !0), (l(), n("svg", { class: g("arrow-paginate " + (a.current === o.total ? "active" : "")), onClick: s[5] || (s[5] = i => c.gotoPage(a.current + 1)), width: "24", height: "25", viewBox: "0 0 24 25", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, za, 2)), t("a", { onClick: s[6] || (s[6] = i => c.gotoPage(o.total)), class: g(a.current === o.total ? "disabled" : "") }, "Last", 2)])]) }
var e1 = m(Ra, [
    ["render", t1],
...
const c1 = { name: "Blog", components: { Pagination: e1, PatternVertical: i1, SectionTitle: L }, data() { return { currentPage: this.$route.params.pageNumber || 1, limit: 5, posts: [], maxLength: 150, pageCount: 1, blogImage: k } }, methods: { getBlogData() { let e = this; return A.get(`${A.routes.postsPage}/${this.currentPage}/${this.limit}`).then(s => { e.posts = s }) }, dateformat(e) { return I(e) }, getPageCount() { return A.get(A.routes.postsCount).then(e => e.total) }, changePage(e) { e === 1 ? (this.currentPage = e, this.$router.push("/blog"), this.getBlogData()) : (this.currentPage = e, this.$router.push(`/blog/page/${e}`), this.getBlogData()) } }, beforeRouteUpdate(e, s, o) { window.scrollTo(0, 0), o() }, mounted() { let e = this;
...
function w1(e, s, o, d, a, c) { const i = u("SectionTitle"),
        r = u("router-link"),
        v = u("Pagination"); return l(), n("div", d1, [p1, t("div", h1, [t("div", u1, [p(i, { title: "Blog" }), t("div", v1, [(l(!0), n(_, null, b(a.posts, w => (l(), n("div", null, [t("div", _1, [t("img", { class: "blog-image", src: w.image_url || a.blogImage }, null, 8, g1), t("div", m1, [t("p", f1, h(w.title), 1), t("p", b1, h(w.content.length > a.maxLength ? w.content.substring(0, a.maxLength) + "..." : w.content), 1), p(r, { class: "blog-card-button btn", to: "/blog/" + w.slug }, { default: Z(() => [C1]), _: 2 }, 1032, ["to"]), t("p", A1, h(c.dateformat(w.published_at)), 1)])])]))), 256))]), p(v, { "current-page": a.currentPage, total: a.pageCount, onPageClick: c.changePage }, null, 8, ["current-page", "total", "onPageClick"])])])]) }
var V = m(c1, [
    ["render", w1],
    ["__scopeId", "data-v-0cefc9c2"]
]);
const y1 = { name: "BlogPage", data() { return { blogImage: null, defaultImage: k, title: "", contents: "", date: "", latestPosts: [], callToAction: "/" } }, methods: { getContent(e) { let s = this; return A.get(A.routes.postContent + e).then(o => { s.title = o.title, s.contents = o.content, s.date = I(o.published_at), s.blogImage = o.image_url, s.callToAction = o.call_to_action }) }, getLatestPosts() { let e = this; return A.get(A.routes.latestPosts + 3).then(s => { e.latestPosts = s }) } }, beforeRouteUpdate(e, s, o) { this.getContent(e.params.slug), this.getLatestPosts().then(d => { window.scrollTo(0, 0), o() }) }, mounted() { this.getContent(this.$route.params.slug), this.getLatestPosts(), window.scrollTo(0, 0) } },
    G = e => (x("data-v-61c5d2cd"), e = e(), B(), e),
    L1 = { class: "bg-blog min-h-screen" },
    M1 = { class: "q-container pb-32 pt-12 md:py-32 mt-24 mb-0" },
    x1 = { class: "breadcrumbs" },
    B1 = G(() => t("u", null, "Blog", -1)),
    Z1 = f(" > "),
    ...
    Q1 = { class: "blog-date" },
    $1 = f("Read More"),
    U1 = { class: "w-full lg:w-1/3 lg:pl-3 lg:pt-0 pt-10" },
    N1 = { class: "blog-latest-posts" },
    Y1 = G(() => t("p", { class: "latest-post-display" }, "Latest Posts", -1)),
    F1 = { key: 0, class: "post-divider" };

function E1(e, s, o, d, a, c) { const i = u("router-link"); return l(), n("div", L1, [t("div", M1, [t("div", x1, [p(i, { to: "/blog/" }, { default: Z(() => [B1]), _: 1 }), Z1, t("p", null, h(a.title), 1)]), t("div", H1, [t("div", k1, [t("div", I1, [t("p", P1, h(a.title), 1), t("img", { src: a.blogImage || a.defaultImage, class: "blog-image" }, null, 8, S1), (l(!0), n(_, null, b(a.contents.split(`
`), r => (l(), n("p", T1, h(r), 1))), 256)), t("p", Q1, h(a.date), 1), p(i, { to: a.callToAction, class: "btn" }, { default: Z(() => [$1]), _: 1 }, 8, ["to"])])]), t("div", U1, [t("div", N1, [Y1, (l(!0), n(_, null, b(a.latestPosts, (r, v) => (l(), n(_, null, [p(i, { to: "/blog/" + r.slug, class: "latest-post-title" }, { default: Z(() => [f(h(r.title), 1)]), _: 2 }, 1032, ["to"]), v !== a.latestPosts.length - 1 ? (l(), n("span", F1)) : y("", !0)], 64))), 256))])])])])]) }
var R1 = m(y1, [
    ["render", E1],
    ["__scopeId", "data-v-61c5d2cd"]
]);
const V1 = [{ path: "/", component: Ea }, { path: "/blog", component: V }, { path: "/blog/page/:pageNumber", component: V }, { path: "/blog/:slug", component: R1 }];
var G1 = z({ routes: V1, history: tt() });
const j = et(Et);
j.use(G1);
j.mount("#app");